...
<input type="radio" name="text_display" value="2" onClick="select_value(this)"> Instance 2 <a href="http://localhost:8080/Recommender System/RecommenderServelet?id=1">click here</a>
